...
export function ItemCard({
  ...
  return (
    <ItemDetailsDialog item={item} open={isDetailsOpen} onOpenChange={setDetailsOpen}>
      <Card
        className={cn(
          'group overflow-hidden transition-all duration-300 shadow-md hover:shadow-xl bg-card/50 border-0 cursor-pointer'
        )}
                   ...
                   <>
                     <AlertDialog>
                      <AlertDialogTrigger asChild>
                        <Button variant="outline" size="icon" className="h-8 w-8 bg-background/80 hover:bg-background" onClick={(e) => e.stopPropagation()}>
