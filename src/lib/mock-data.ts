...
export const mockClothingItems: ClothingItem[] = [
  ...
  createMockItem('4', 'item4', 'Outerwear', { category: 'Top', color: 'Red', fabric: 'Cotton', season: 'Summer', occasion: 'Casual', warmth: 2, relaxed: 8, isFavorite: true }),
  ...
  createMockItem('9', 'item9', 'Bottom', { category: 'Bottom', color: 'Blue', fabric: 'Denim', season: 'Summer', occasion: 'Casual', relaxed: 9, warmth: 2, lastWorn: '2024-07-22T12:00:00.000Z' }),
