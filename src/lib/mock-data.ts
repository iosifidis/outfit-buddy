...
export const mockClothingItems: ClothingItem[] = [
  { id: '1', userId: 'user1', imageUrl: getImage('item1'), color: 'White', fabric: 'Silk', pattern: 'Solid', season: 'Autumn', length: 'Long', category: 'Top', occasion: 'Business', description: 'White Silk Blouse', lastWorn: null },
  { id: '2', userId: 'user1', imageUrl: getImage('item2'), color: 'Black', fabric: 'Wool', pattern: 'Solid', season: 'Autumn', length: 'Long', category: 'Bottom', occasion: 'Business', description: 'Black Wool Trousers', lastWorn: '2023-10-15' },
  { id: '3', userId: 'user1', imageUrl: getImage('item3'), color: 'Black', fabric: 'Leather', pattern: 'Solid', season: 'Autumn', length: 'Mini', category: 'Shoes', occasion: 'Business', description: 'Black Leather Loafers', lastWorn: '2023-10-20' },
  ...
  { id: '11', userId: 'user1', imageUrl: getImage('item11'), color: 'Multicolor', fabric: 'Viscose', pattern: 'Floral', season: 'Spring', length: 'Long', category: 'Top', occasion: 'Casual', description: 'Floral Print Blouse', lastWorn: null },
  { id: '12', userId: 'user1', imageUrl: getImage('item12'), color: 'White', fabric: 'Canvas', pattern: 'Solid', season: 'Summer', length: 'Mini', category: 'Shoes', occasion: 'Casual', description: 'White Canvas Sneakers', lastWorn: '2023-10-25' },
];
