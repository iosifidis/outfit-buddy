...
export const mockClothingItems: ClothingItem[] = [
  ...
  { id: '9', userId: 'user1', imageUrl: getImage('item9'), color: 'Blue', fabric: 'Denim', pattern: 'Solid', season: 'Summer', length: 'Mini', category: 'Bottom', occasion: 'Casual', description: 'High-waisted Denim Shorts', lastWorn: '2023-08-15', formal: 1, warmth: 1, relaxed: 9 },
  ...
  { id: '11', userId: 'user1', imageUrl: getImage('item11'), color: 'Multicolor', fabric: 'Viscose', pattern: 'Floral', season: 'Spring', length: 'Long', category: 'Top', occasion: 'Casual', description: 'Floral Print Blouse', lastWorn: null, formal: 4, warmth: 2, relaxed: 7 },
  { id: '12', userId: 'user1', imageUrl: getImage('item12'), color: 'White', fabric: 'Canvas', pattern: 'Solid', season: 'Summer', length: 'Mini', category: 'Shoes', occasion: 'Casual', description: 'White Canvas Sneakers', lastWorn: '2023-10-25', formal: 2, warmth: 1, relaxed: 9 },
];
